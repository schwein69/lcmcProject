// Generated from C:/Users/11858/Desktop/IntelliProjects/FOOL ASM/src/svm/SVM.g4 by ANTLR 4.13.2
package svm;
...
public class SVMParser extends Parser {
	...
	public static final int
		...
		HALT=23, COL=24, LABEL=25, INTEGER=26, WHITESP=27, COMMENT=28, ERR=29;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"HALT", "COL", "LABEL", "INTEGER", "WHITESP", "COMMENT", "ERR"
		};
	}
	...
	public final AssemblyContext assembly() throws RecognitionException {
		...
		try {
			...
			setState(10);
			match(EOF);
			for (Integer j: labelRef.keySet()) code[j] = labelDef.get(labelRef.get(j));
			}
		}
		...
		try {
			...
			case 1:
				...
				((InstructionContext)_localctx).n = match(INTEGER);
				 code[i++] = PUSH; code[i++] = Integer.parseInt((((InstructionContext)_localctx).n!=null?((InstructionContext)_localctx).n.getText():null)); 
				}
				break;
			case 2:
				...
				((InstructionContext)_localctx).l = match(LABEL);
				 code[i++] = PUSH; labelRef.put(i++,(((InstructionContext)_localctx).l!=null?((InstructionContext)_localctx).l.getText():null));
				}
				break;
			case 3:
			...
			case 11:
				...
				setState(37);
				((InstructionContext)_localctx).l = match(LABEL);
				 code[i++] = BRANCH; labelRef.put(i++,(((InstructionContext)_localctx).l!=null?((InstructionContext)_localctx).l.getText():null));
				}
				break;
			case 12:
				...
				setState(40);
				((InstructionContext)_localctx).l = match(LABEL);
				 code[i++] = BRANCHEQ; labelRef.put(i++,(((InstructionContext)_localctx).l!=null?((InstructionContext)_localctx).l.getText():null));
				}
				break;
			case 13:
				...
				setState(43);
				((InstructionContext)_localctx).l = match(LABEL);
				 code[i++] = BRANCHLESSEQ; labelRef.put(i++,(((InstructionContext)_localctx).l!=null?((InstructionContext)_localctx).l.getText():null));
				}
				break;
			case 14:
